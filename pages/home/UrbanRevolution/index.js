      ...
      return <Fragment>
        ...
        <div className={`mt-10 sm:mt-0 ${styles.urbanRevolutionCol2}`}>
          ...
          <picture>
              ...
              <source srcSet="/static/images/bicycle@2x_mobile.png" media={`(max-width: 886px) and (-webkit-min-device-pixel-ratio: 1.25) and ( min--moz-device-pixel-ratio: 1.25) and ( -o-min-device-pixel-ratio: 1.25/1) and ( min-device-pixel-ratio: 1.25) and ( min-resolution: 200dpi) and ( min-resolution: 1.25dppx))`} />
