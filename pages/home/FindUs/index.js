  ...
  return (
    <section>
      <animated.h2
        ...
        className={`text-blue-100 text-center sm:text-left ${titleMargins}`}
      >
        {title}
      </animated.h2>
      <animated.div
      ...
      <animated.div
        ...
        className="fb-page flex justify-center sm:block w-full"
        data-href="https://www.facebook.com/ilicycles/"
        data-tabs="journal"
        data-height="140"
      ...
      >
        <blockquote cite="https://www.facebook.com/ilicycles/" className="fb-xfbml-parse-ignore">
          <a href="https://www.facebook.com/ilicycles/">Ili cycles</a>
        </blockquote>
      </animated.div>
