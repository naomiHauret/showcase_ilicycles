      ...
      <Layout theme="light" locale={locale} content={layoutContent} seo={seo}>
        {this.props.error ? (
          ...
          <Fragment>
              ...
              {/******************** ************************  ********************/}
              {/************************* DAILY TRAVELS ***************************/}
              <DailyTravel margins="mt-40 sm:mt-90" title={content.dailytrip_title} features={content.features} locale={locale} />
              ...
              <Container contained={true} staticStyles="mb-70 md:mb-110 mt-40 sm:mt-80 flex flex-col sm:grid sm:gap-30 sm:grid-col-12">
                <div className={`${styles.gridSocialsCol1}`}>
                  ...
                  <MediaQuery minDeviceWidth={pxTo(ds.get("breakpoints.sm"), baseFontSize, "rem")}>
                    <Catalog titleMargins="mb-20 sm:mb-30" downloadUrl={content.catalogue_link.url} title={content.catalogue_title} text={RichText.render(content.catalogue_text)} />
                  </MediaQuery>
                </div>
                {/************************************** CONTACT US **************************************/}
