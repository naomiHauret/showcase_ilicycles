    ...
    <Fragment>
      ...
      <TranslationContext.Provider value={translation}>
        <animated.header
          style={useSpring({
            to: {
              background: scrollY < SCROLLBYTRIGGER ? "rgba(255, 255, 255, 0)" : "rgba(255, 255, 255, 1)",
            },
            from: {
              background: scrollY < SCROLLBYTRIGGER ? "rgba(255, 255, 255, 0)" : "rgba(255, 255, 255, 1)",
            },
        ...
        ${scrollY < SCROLLBYTRIGGER ? "md:py-50 md:shadow-none" : "md:py-5 md:shadow-lg"}
        ${scrollY < SCROLLBYTRIGGER ? themeSystem.color[theme] : "text-black-100"}`}
        >
          <nav>
            <Container contained={true} staticStyles="flex items-center">
              ...
              <div className="ml-auto">
                <SelectLanguage isDark={scrollY > SCROLLBYTRIGGER} theme={theme} router={router} onChange={setLocale} />
              </div>
            </Container>
          </nav>
        </animated.header>
        ...
        {withForm && (
          <FormContact locale={locale} title={content.move_title} text={RichText.render(content.move_text)} />
        )}
          ...
          <Container contained={true} staticStyles={`grid gap-30 ${styles.footerGrid}`}>
            <nav className={styles.navigation}>
              ...
              <ul className="list-none p-0">
                ...
                <li>
                  <Link prefetch passHref as={`/${locale}/brand`} href={`/brand?lang=${locale}`}>
                    <a className=" tw-unstyled-link">
                      <Translate id="layout.menu.brand" />
                    </a>
                  </Link>
                ...
                <li>
                  <Link prefetch passHref as={`#contact`} href={`#contact`}>
                    <a className=" tw-unstyled-link">
                      <Translate id="layout.menu.contact" />
                    </a>
                  </Link>
                ...
                <li>
                  <Link prefetch passHref as={`/${locale}/legal`} href={`/legal?lang=${locale}`}>
                    <a className=" tw-unstyled-link">
            ...
            <div className={styles.openingTimesAndContact}>
              ...
              <div className="font-400 text-12 tracking-0 mt-20">
                {content.footer_text_time}
                <div className="mt-25">{RichText.render(content.footer_text_address)}</div>
                <div className="mt-40">
                  <a className="tw-unstyled-link flex items-center mb-10" href="https://www.facebook.com/ilicycles/">
                    <svg
                      aria-hidden="true"
                      className={`${styles.icon} block mr-15`}
                      xmlns="http://www.w3.org/2000/svg"
                      viewBox="0 0 448 512"
                    >
                      <path
            ...
            <div className={styles.mission}>
              ...
              <div className="mt-20 font-400 text-12 tracking-0">{RichText.render(content.footer_text_mission)}</div>
            </div>
          </Container>
          <Container staticStyles="text-9 font-400 text-center mt-40 md:mt-60" contained={true}>
